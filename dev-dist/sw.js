...
define(['./workbox-bab94477'], (function (workbox) { 'use strict';
  ...
  workbox.registerRoute(/assets\/.*\.(mp4|png|jpg|jpeg|svg|glb|mp3|hdr)$/, new workbox.CacheFirst({
    "cacheName": "asset-cache",
    plugins: [new workbox.ExpirationPlugin({
      maxEntries: 100,
      maxAgeSeconds: 5184000
