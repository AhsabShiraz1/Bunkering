...
export default function IrmConclusion({ setNotification, setCurrentLevel }: LevelProps) {
  ...
  const questions: Question[] = [
    {
      question: "Adani Bunkering services is the leading provider of which item in India and globally",
      options: ["Bunker grade fuel", "Edible oil", "Aviation fuel", "Kerosene"],
      values: [1, 0, 0, 0],
    },
    {
      question: "Which ship is used to carry bunker grade fuel",
      options: ["Vessel", "Barge", "Oil ship", "Container ship"],
      values: [0, 1, 0, 0],
    },
    {
      question: "What does T-18 tank store",
      options: ["Monomers", "Polymers", "Oligomers", "Catalyst"],
      values: [1, 0, 0, 0],
    },
    {
      question: "What is group of tanks at liquid fuel terminal called",
      options: ["Tanker-grid", "Enclosure", "pump house", "jetty"],
      values: [0, 1, 0, 0],
    }
  ];
  ...
  useEffect(() => {
    setNotification("This marks the end of Bunkering module. Please enter your session ID to begin.");
  ...
  const handleOptionClick = (index: number) => {
    ...
    localStorage.setItem(`Bunkering-${sessionId}-question${currentQuestionIndex + 1}`, isCorrect ? "1" : "0");
